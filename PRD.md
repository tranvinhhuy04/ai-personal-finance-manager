# Tài liệu Yêu cầu Sản phẩm (PRD) - OripioFin

## 1. Tổng quan

### 1.1 Tên dự án
**OripioFin** - Nền tảng quản lý tài chính cá nhân đa ví, tích hợp AI.
...
OripioFin được xây dựng để giải quyết các vấn đề cốt lõi sau:
